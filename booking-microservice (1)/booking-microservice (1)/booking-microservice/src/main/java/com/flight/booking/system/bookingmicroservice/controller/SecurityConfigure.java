...
import com.flight.booking.system.bookingmicroservice.config.JwtRequestFilter;
...
public class SecurityConfigure extends WebSecurityConfigurerAdapter{
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.csrf().disable()
.authorizeRequests().antMatchers("/v3/api-docs/**","/swagger-ui/**","/book/reg","/book/authenticate","/book/**").permitAll().anyRequest().authenticated()
