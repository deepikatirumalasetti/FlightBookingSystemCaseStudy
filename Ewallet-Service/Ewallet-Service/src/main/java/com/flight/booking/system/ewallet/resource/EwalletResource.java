package com.flight.booking.system.ewallet.resource;
...
import com.flight.booking.system.ewallet.repositories.EwalletRepository;
import com.flight.booking.system.ewallet.repositories.StatementRepository;
import com.flight.booking.system.ewallet.service.EwalletService;
...
public class EwalletResource {
	...
	public String onlinePayment( @PathVariable int amount ) throws RazorpayException {
		...
		System.out.println(amt);
		 ...
		 RazorpayClient client =  new RazorpayClient("rzp_test_iUpmYGYmitAxZ0","EFaseridaoe0hmC1en3VAISN" );
